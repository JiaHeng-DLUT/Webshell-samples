...
<body>
    ...
    <div><br>
        <p>1、如果您在安装过程中出现本页提示，那么请检查web运行环境配置是否正确；</p>
        <p>2、如果您正在制作主题，那么请检查标签是否使用正确；</p>
        <p>3、如果您正在制作插件，那么请检查插件是否符合标准；</p>
        <p>4、如果您只是在使用过程中出现本页提示，那么请检查是否对某项设置进行了变更。</p>
        <p>5、如果以上原因都排除，那么可能是您的服务器正繁忙，请稍后刷新页面。</p>
    </div>
    <div class="copyright">
