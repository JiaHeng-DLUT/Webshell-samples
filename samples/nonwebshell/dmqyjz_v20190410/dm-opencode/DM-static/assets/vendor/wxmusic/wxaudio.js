...
(function (window, document) {
	...
	Wxaudio.prototype = {
		...
		initDom: function () {
			...
			//this.wxAudioStateImg.src = 'pause.png'
			this.wxAudioStateImg.src = document.getElementById("wxaudio1").dataset.path+'pause.png' 
		...
		initAudioEvent: function () {
			...
			_this.wxAudio.onplaying = function () {
				...
				_this.wxAudioStateImg.src = document.getElementById("wxaudio1").dataset.path+'playing.gif'
			},
			_this.wxAudio.onpause = function () {
				_this.isPlaying = false
				_this.showLoading(false)
				_this.wxAudioStateImg.src = document.getElementById("wxaudio1").dataset.path+'pause.png'
			},
