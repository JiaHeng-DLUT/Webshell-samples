 ...
 <tr>
  ...
  <tr>
    ...
    <?php select_from_arr($arr_editor,$editor,'');?>
          ...
          <br /><span class="cgray">如果选择其他编辑器，需要下载相关文件，<a href="<?php echo $dmlink_editor;?>" target="_blank">具体请看教程></a></span>
 </td>
    </tr>
    ...
    <?php select_from_arr($arr_yn,$sta_frontedit,'');?>
      ...
      <a href="<?php echo $dmlink_frontedit;?>" target="_blank">什么是前台编辑</a>
   </td>
    </tr> 
      <tr>
      <td class="tr">样式缓存：</td>
...
<input name="linkofmobile" type="text"   value="<?php echo $linkofmobile;?>" size="35">
  <br /> <span class="cgray">必须以 http开头，比如http://m.sohu.com。如果没有，请留空。 </span>
    ...
    <tr>
      ...
      <td>  
      <input name="searchtext" type="text"  value="<?php echo $searchtext;?>" size="35">
