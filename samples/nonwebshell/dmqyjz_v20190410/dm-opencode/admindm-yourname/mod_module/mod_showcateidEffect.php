...
<?php
 $sqlmain = "SELECT * from ".TABLE_CATE." where  pid='0' and modtype='blockdh' $andlangbh order by pos desc,id";
  ...
  echo '<ul class="seolist ">';
   foreach($rowlistmain as $vmain){
        ...
        $namemain='<strong>'.decode($vmain['name']).'</strong>';
         ...
         echo '<li>';
        echo '<h3><a target="_blank" href="../mod_category/mod_fefilecate.php?lang='.LANG.'">'.$namemain.'</a> - <span class="cgray">'.$pidnamemain.' </span></h3>';
