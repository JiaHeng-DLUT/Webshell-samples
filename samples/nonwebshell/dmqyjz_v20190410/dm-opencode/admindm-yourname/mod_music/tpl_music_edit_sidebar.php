<?php 
 $sql="select * from  ".TABLE_MUSIC."  where  pid='$pid' and type='$type' $andlangbh order by pos desc,id desc";
 //echo $sql;
   $rowlist = getall($sql);
 ...
 //mod_music.php?lang=en&pid=&ppid=album20180726_1147127952&file=edit&tid=10&act=edit
