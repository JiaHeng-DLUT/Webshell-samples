...
/*******put initial value*************************************/
  ...
  $pidnamehere = 'salbum' . $bshou;
	$ss = "insert into ".TABLE_MUSIC." (pidname,pbh,pid,kvsm,size,type,lang) values ('$pidnamehere','$user2510','$pid','$return_v',$imgsize,'$type','".LANG."')";//no pos,because pos is auto,is to next and prev page
	iquery($ss);
		//echo $ss;exit;
}//end not empty
//else{alert('请选择图片');}
