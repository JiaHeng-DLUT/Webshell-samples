...
if($act=='update'){
 ...
 $jump_back = $jumpv_pf.'&act=edit';
  ...
  $ss = "update ".TABLE_STYLE." set title='$abc1',htmldir='$abc2',pidmenu='$abc3',pidregion='$abc4',addcss='$addcss',addjs='$addjs',headereffect='$abc7' $kv_v where pidname='$pidname' $andlangbh limit 1";
   //echo $ss;exit;    
   iquery($ss);  
  ...
  if($v<>'base'){
   ...
   // and (pidstylebh='y' or pidstylebh='$pidname') 
    ...
    <tr>
      ...
      <td >
    <textarea class="form-control" rows="3" name="addcss"><?php echo $addcss; ?></textarea> <?php echo $xz_maybe; ?>

    <p class="cgray">参考：  assets/vendor/singlecss/font-awesome.css</p>
    </td>
    </tr>
    ...
    <tr>
      ...
      <td >
    <textarea class="form-control" rows="3" name="addjs"><?php echo $addjs; ?></textarea> <?php echo $xz_maybe; ?>
    </td>
    </tr>
   ...
   <?php 
        ...
        echo '<select name="headereffect">';
        echo '<option value="mbheader">使用当前模板下的tpl/header.tpl.php</option>';
         select_from_filearr($filedir,$headereffect); 
        echo '</select>'; 

        if($headereffect<>'') {
          
           if($headereffect=='mbheader')  $filename =  $htmldir.'/tpl/header.tpl.php';
           else  $filename =  'base/block/header/'.$headereffect;  
