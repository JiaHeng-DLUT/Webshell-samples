...
$title2=$title3='';
 ...
 $editformv = '../mod_form/mod_form.php?lang='.LANG.'&pid=block&type=block&file=addedit&act=edit&pidname='.$pid;
 
 $editformv2 =' -  <a href="'.$editformv.'">修改</a>';


if($act=='list') $title2= '<a style="font-size:18px" href="mod_form.php?lang='.LANG.'">表单区块管理</a> - '.$title.$editformv2;
