    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <div class="layui-btn-group layui-inline" style="padding-bottom: 10px">
                ...
                @endcan
                  {{--  <a class="layui-btn layui-btn-normal layui-btn-sm" id="autoUpLoan">未 注 册</a>
                    <a class="layui-btn layui-btn-normal layui-btn-sm" id="autoUpLoan1">未申请和流失</a>--}}
            </div>
...
@section('script')
    <script>
        layui.use(['layer','table','form'],function () {
            ...
            //上下架测试
            {{--$("#autoUpLoan").click(function () {--}}
               {{--window.location.href="{{ route('admin.msg.cron.no.register') }}";--}}
                {{--//window.location.href="{{ route('admin.msg.cron.no.apply') }}";--}}
            {{--})--}}
            {{--//上下架测试--}}
            {{--$("#autoUpLoan1").click(function () {--}}
               {{--// window.location.href="{{ route('admin.msg.cron.no.register') }}";--}}
                {{--window.location.href="{{ route('admin.msg.cron.no.apply') }}";--}}
            {{--})--}}
