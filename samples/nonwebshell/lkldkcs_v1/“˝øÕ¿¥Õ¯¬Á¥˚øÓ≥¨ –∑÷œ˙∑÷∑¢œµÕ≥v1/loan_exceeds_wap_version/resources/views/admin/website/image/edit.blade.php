...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="{{ url('admin/website/image/'.$id.'/update') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data" id="myform">
                {{csrf_field()}}
                {{method_field('put')}}
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <div class="layui-upload">
                                        ...
                                        <span class="help">请上传1M以内的png、jpg格式的图片 移动端建议尺寸：750*300px，PC根据位置和尺寸决定</span><span><a class="layui-btn layui-btn-danger delete" href="javascript:;" {{--onclick="del(this,'{{ $item->id }}')"--}} onclick="_del({{$item['id']}})" >移除</a></span>
