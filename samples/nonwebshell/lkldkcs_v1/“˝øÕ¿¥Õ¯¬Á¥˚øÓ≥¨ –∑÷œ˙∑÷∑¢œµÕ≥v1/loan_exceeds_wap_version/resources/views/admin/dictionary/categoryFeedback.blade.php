            ...
            <form class="layui-form" action="javascript:void(0)">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <label for="" class="layui-form-label" style="width: 100px">意见反馈分类</label>
                    </div>
                </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <div class="layui-input-inline">
                                        ...
                                        <input type="text" name="old[{{$category->id}}][name]" maxlength="{{$model->per_length}}" value="{{$category->name}}" lay-verify="required|unique" class="layui-input category-item" placeholder="字段值">
                                    </div>
                                    <div class="layui-input-inline" style="width: 100px;">
                                        <input type="number" min="0" max="999" name="old[{{$category->id}}][sort]" value="{{$category->sort}}" lay-verify="required" class="layui-input" placeholder="字段排序">
                                    </div>
                                    <div class="layui-input-inline">
        ...
        layui.use('form', function(){
            ...
            $('#add').on('click',function () {
                ...
                var html='<div class="layui-form-item">\n'+
                    '                        <div class="layui-input-block">\n' +
                    '                            <div class="layui-input-inline">\n' +
                    '                                <input type="text"  name="new['+index+'][name]" maxlength="{{$model->per_length}}" value="" lay-verify="required|unique" class="layui-input category-item" placeholder="字段值">\n' +
                    '                            </div>\n' +
                    '                            <div class="layui-input-inline" style="width: 100px;">\n' +
            ...
            form.on('submit(save-category)', function(data){
                $.post("{{route('admin.feedback.category.store')}}",data.field,function (res) {
                    if(res.code===0){
