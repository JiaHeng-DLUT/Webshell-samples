            ...
            <form class="layui-form" action="javascript:void(0)">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <label for="" class="layui-form-label">信用卡角标</label>
                    </div>
                </div>
        ...
        layui.use(['form','upload'], function(){
            ...
            $('#add').on('click',function () {
                ...
                var html='<div class="layui-form-item">\n'+
                    ...
                    '                                        <div class="layui-upload-list">\n' +
                    '                                            <img class="layui-upload-img" id="new['+index+'][img]" style="width: 64px;height: 78px" >\n' +
                    '                                            <input type="hidden" lay-verify="corner_url" name="new['+index+'][url]" id="new['+index+'][url]" value="">\n' +
                    '                                        </div>\n' +
                    '                                           <span>建议尺寸 : 60*72</span>'+
                    '                                    </div>\n'+
                    '                            <div class="layui-input-inline">\n' +
                    '                                <input type="hidden"  name="new['+index+'][type]"  value="credit">\n' +
            ...
            form.on('submit(save-corner)', function(data){
                $.post("{{route('admin.credit.corner.store')}}",data.field,function (res) {
                    if(res.code===0){
