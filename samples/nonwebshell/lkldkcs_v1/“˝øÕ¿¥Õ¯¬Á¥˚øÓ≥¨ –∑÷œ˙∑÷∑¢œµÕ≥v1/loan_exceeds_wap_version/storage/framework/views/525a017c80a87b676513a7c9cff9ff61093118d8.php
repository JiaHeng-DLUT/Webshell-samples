        ...
        <div class="layui-card-header layuiadmin-card-header-auto layui-form">
                ...
                <div class="layui-inline" >
                    ...
                    <div class="layui-input-inline">
                        <select name="register_channel_name"  id="register_channel_name" lay-search>
                            ...
                            <?php if(count($register_channel_name)): ?>
                                <?php $__currentLoopData = $register_channel_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->register_channel_name); ?>"><?php echo e($item->register_channel_name); ?></option>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="register_page_name"  id="register_page_name" lay-search>
                            ...
                            <?php if(count($register_page_name)): ?>
                                <?php $__currentLoopData = $register_page_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->register_page_name); ?>"><?php echo e($item->register_page_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="operate_channel_name"  id="operate_channel_name" lay-search>
                            ...
                            <?php if(count($operate_channel_name)): ?>
                                <?php $__currentLoopData = $operate_channel_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->operate_channel_name); ?>"><?php echo e($item->operate_channel_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="operate_page_name"  id="operate_page_name" lay-search>
                            ...
                            <?php if(count($operate_page_name)): ?>
                                <?php $__currentLoopData = $operate_page_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->operate_page_name); ?>"><?php echo e($item->operate_page_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
            ...
            <div>
                <div class="layui-btn-group">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.behaviorlog.toExcel')): ?>
...
<?php $__env->startSection('script'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.behaviorlog')): ?>
        <?php echo $__env->make('admin.common._js_department_get_channel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <script>
            layui.use(['layer','table','form','laydate'],function () {
                ...
                var dataTable = table.render({
                    elem: '#dataTable'
                    // ,height: 500
                    ,url: "<?php echo e(route('admin.behaviorlog.data')); ?>" //数据接口
                    ,page: true //开启分页
                    ,cols: [[ //表头
                ...
                $("#toExcel").click(function () {
                    ...
                    var u = '<?php echo e(route('admin.behaviorlog.toExcel')); ?>';
