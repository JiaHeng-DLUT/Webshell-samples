        ...
        <div class="layui-card-header layuiadmin-card-header-auto layui-form">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" style="width: 600px">
                        <select name="user_model_id[]" id="user_model_id" xm-select-search="" xm-select-search-type="dl" xm-select="select1" size="300">
                            <?php if(count($user_models)): ?>
                                <option value="">用户模型</option>
                                <?php $__currentLoopData = $user_models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user_model->id); ?>" ><?php echo e($user_model->name); ?></option>
                        ...
                        <select name="app_id"  id="app_id" lay-search>
                            ...
                            <?php if(count($channels)): ?>
                                <?php $__currentLoopData = $channels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($channel->channel_code); ?>" ><?php echo e($channel->channel_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                <div class="layui-btn-group">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.member.toExcel')): ?>
...
<?php $__env->startSection('script'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.member')): ?>
        ...
        <script>
            layui.use(['layer','table','form','laydate'],function () {
                ...
                $("#toExcel").click(function () {
                    ...
                    var u = '<?php echo e(route('admin.member.toExcel')); ?>';
