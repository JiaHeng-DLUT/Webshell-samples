        ...
        <div class="layui-card-header layuiadmin-card-header-auto layui-form">
            ...
            <div>
                <div class="layui-btn-group">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.apply.toExcel')): ?>
...
<?php $__env->startSection('script'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.apply')): ?>
        ...
        <script>
            layui.use(['layer','table','form','laydate','laypage'],function () {
                ...
                var dataTable = table.render({
                    elem: '#dataTable'
                    // ,height: 500
                    ,url: "<?php echo e(route('admin.apply.data')); ?>" //数据接口
                    ,page: true //开启分页
                    ,cols: [[ //表头
                ...
                $("#toExcel").click(function () {
                    ...
                    var phone = $("#phone").val();
                    var u = '<?php echo e(route('admin.apply.toExcel')); ?>';
