    ...
    <div class="layui-card">
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group ">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.website.article.destroy')): ?>
                    <a class="layui-btn layui-btn-sm "  href="<?php echo e(route('admin.userModel.refreshSnapshot')); ?>">刷新人数</a>
                <?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.userModel.create')): ?>
                    <a class="layui-btn layui-btn-sm" href="<?php echo e(route('admin.userModel.create')); ?>">添 加</a>
                <?php endif; ?>
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="options">
                <div class="layui-btn-group">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.userModel.edit')): ?>
...
<?php $__env->startSection('script'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member.userModel')): ?>
        <script>
            layui.use(['layer','table','form','laydate'],function () {
                ...
                var dataTable = table.render({
                    elem: '#dataTable'
                    // ,height: 500
                    ,url: "<?php echo e(route('admin.userModel.data')); ?>" //数据接口
                    ,page: true //开启分页
                    ,cols: [[ //表头
