...
if(is_dir('template')==false || is_dir('wap')==false || is_dir('admin')==false){
	die("缺少文件，请检查template、wap、admin文件夹是否存在！");
}
...
<a class="btn btn-primary" href="?step=2" onClick="$('#update_info').show();" style="margin:0 20px;">
下一步</a>
