...
<div class="panel panel-default">
    ...
    <iframe src="conn/code_1.php?name=G_code" scrolling="no" frameborder="0" width="100%" height="40"></iframe>
...
if ($action=="save"){
if(xcode($_POST["G_code"],'DECODE',$_SESSION["CmsCode"],0)!=$_SESSION["CmsCode"]){
