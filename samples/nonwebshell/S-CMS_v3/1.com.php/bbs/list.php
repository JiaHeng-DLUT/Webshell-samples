...
$sql="Select * from SL_bsort where S_del=0 and S_id=".$id;
...
<?php 
if ($S_sh==0){
$sql="select * from SL_bbs where B_del=0 and B_sort=".$id." and B_sub=0 order by B_id desc";
}else{
$sql="select * from SL_bbs where B_del=0 and B_sort=".$id." and B_sub=0 and B_sh=1 order by B_id desc";
}
