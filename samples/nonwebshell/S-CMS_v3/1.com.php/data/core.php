...
function creat_index($T_lang) {
    ...
    if (strpos($T_lang, "0") !== false) {
        setlang("cn");
        file_put_contents("../html/index.html", e(d(CreateIndex(c(b(a("index", 1)) , "index")))));
    }
    if (strpos($T_lang, "2") !== false) {
        setlang("cht");
        file_put_contents("../fhtml/index.html", cnfont(e(d(CreateIndex(c(b(a("index", 1)) , "index")))) , "f"));
    }
    if (strpos($T_lang, "1") !== false) {
        setlang("en");
        file_put_contents("../ehtml/index.html", e(d(CreateIndex(c(b(a("index", 1)) , "index")))));
    }
}
...
function creat_text($T_lang, $T_id="") {
    ...
    if (check_auth2("x1")) {
        if ($T_id == "") {
            $sqlx = "select * from SL_text where T_del=0 order by T_order,T_id desc";
        } else {
        ...
        if (mysqli_num_rows($resultx) > 0) {
            while ($rowx = mysqli_fetch_assoc($resultx)) {
                if (strpos($T_lang, "0") !== false) {
                    setlang("cn");
                    file_put_contents("../html/about/" . $rowx["T_id"] . ".html", e(d(CreateText(c(b(a("text", $rowx["T_id"])) , "text") , $rowx["T_id"]))));
                }
                if (strpos($T_lang, "2") !== false) {
                    setlang("cht");
                    file_put_contents("../fhtml/about/" . $rowx["T_id"] . ".html", cnfont(e(d(CreateText(c(b(a("text", $rowx["T_id"])) , "text") , $rowx["T_id"]))) , "f"));
                }
                if (strpos($T_lang, "1") !== false) {
                    setlang("en");
                    file_put_contents("../ehtml/about/" . $rowx["T_id"] . ".html", e(d(CreateText(c(b(a("text", $rowx["T_id"])) , "text") , $rowx["T_id"]))));
                }
            }
        }
        setlang($C_delang);
    ...
    if (check_auth2("x1")) {
        ...
        if (mysqli_num_rows($resultx) > 0) {
            while ($rowx = mysqli_fetch_assoc($resultx)) {
                if (strpos($T_lang, "0") !== false) {
                    setlang("cn");
                    file_put_contents("../html/news/" . $rowx["N_id"] . ".html", e(d(CreateNewsInfo(c(b(a("newsinfo", $rowx["N_id"])) , "newsinfo") , $rowx["N_id"]))));
                }
                if (strpos($T_lang, "2") !== false) {
                    setlang("cht");
                    file_put_contents("../fhtml/news/" . $rowx["N_id"] . ".html", cnfont(e(d(CreateNewsInfo(c(b(a("newsinfo", $rowx["N_id"])) , "newsinfo") , $rowx["N_id"]))) , "f"));
                }
                if (strpos($T_lang, "1") !== false) {
                    setlang("en");
                    file_put_contents("../ehtml/news/" . $rowx["N_id"] . ".html", e(d(CreateNewsInfo(c(b(a("newsinfo", $rowx["N_id"])) , "newsinfo") , $rowx["N_id"]))));
                }
            }
        }
        setlang($C_delang);
    ...
    if (check_auth2("x1")) {
        ...
        if (mysqli_num_rows($resultx) > 0) {
            while ($rowx = mysqli_fetch_assoc($resultx)) {
                ...
                if (strpos($T_lang, "0") !== false) {
                    setlang("cn");
                    file_put_contents("../html/news/list-" . $rowx["S_id"] . ".html", e(d(CreateNewsList(c(b(a("news", $rowx["S_id"])) , "news") , $rowx["S_id"], 1))));
                    for ($q = 1; $q < $page_num + 1; $q++) {
                        file_put_contents("../html/news/list-" . $rowx["S_id"] . "-" . $q . ".html", e(d(CreateNewsList(c(b(a("news", $rowx["S_id"])) , "news") , $rowx["S_id"], $q))));
                    }
                }
                if (strpos($T_lang, "2") !== false) {
                    setlang("cht");
                    file_put_contents("../fhtml/news/list-" . $rowx["S_id"] . ".html", cnfont(e(d(CreateNewsList(c(b(a("news", $rowx["S_id"])) , "news") , $rowx["S_id"], 1))) , "f"));
                    for ($q = 1; $q < $page_num + 1; $q++) {
                        file_put_contents("../fhtml/news/list-" . $rowx["S_id"] . "-" . $q . ".html", cnfont(e(d(CreateNewsList(c(b(a("news", $rowx["S_id"])) , "news") , $rowx["S_id"], $q))) , "f"));
                    }
                }
                if (strpos($T_lang, "1") !== false) {
                    setlang("en");
                    file_put_contents("../ehtml/news/list-" . $rowx["S_id"] . ".html", e(d(CreateNewsList(c(b(a("news", $rowx["S_id"])) , "news") , $rowx["S_id"], 1))));
                    for ($q = 1; $q < $page_num + 1; $q++) {
                        file_put_contents("../ehtml/news/list-" . $rowx["S_id"] . "-" . $q . ".html", e(d(CreateNewsList(c(b(a("news", $rowx["S_id"])) , "news") , $rowx["S_id"], $q))));
                    }
                }
            }
        }
        ...
        if (strpos($T_lang, "0") !== false) {
            setlang("cn");
            file_put_contents("../html/news/list-0.html", e(d(CreateNewsList(c(b(a("news", 0)) , "news") , 0, 1))));
            for ($q = 1; $q < $page_num + 1; $q++) {
                file_put_contents("../html/news/list-0-" . $q . ".html", e(d(CreateNewsList(c(b(a("news", 0)) , "news") , 0, $q))));
            }
        }
        if (strpos($T_lang, "2") !== false) {
            setlang("cht");
            file_put_contents("../fhtml/news/list-0.html", cnfont(e(d(CreateNewsList(c(b(a("news", 0)) , "news") , 0, 1))) , "f"));
            for ($q = 1; $q < $page_num + 1; $q++) {
                file_put_contents("../fhtml/news/list-0-" . $q . ".html", cnfont(e(d(CreateNewsList(c(b(a("news", 0)) , "news") , 0, $q))) , "f"));
            }
        }
        if (strpos($T_lang, "1") !== false) {
            setlang("en");
            file_put_contents("../ehtml/news/list-0.html", e(d(CreateNewsList(c(b(a("news", 0)) , "news") , 0, 1))));
            for ($q = 1; $q < $page_num + 1; $q++) {
                file_put_contents("../ehtml/news/list-0-" . $q . ".html", e(d(CreateNewsList(c(b(a("news", 0)) , "news") , 0, $q))));
            }
        }
        setlang($C_delang);
    }
    ...
    if (check_auth2("x1")) {
        ...
        if (mysqli_num_rows($resultx) > 0) {
            while ($rowx = mysqli_fetch_assoc($resultx)) {
                if (strpos($T_lang, "0") !== false) {
                    setlang("cn");
                    file_put_contents("../html/product/" . $rowx["P_id"] . ".html", e(d(CreateProductInfo(c(b(a("productinfo", $rowx["P_id"])) , "productinfo") , $rowx["P_id"]))));
                }
                if (strpos($T_lang, "2") !== false) {
                    setlang("cht");
                    file_put_contents("../fhtml/product/" . $rowx["P_id"] . ".html", cnfont(e(d(CreateProductInfo(c(b(a("productinfo", $rowx["P_id"])) , "productinfo") , $rowx["P_id"]))) , "f"));
                }
                if (strpos($T_lang, "1") !== false) {
                    setlang("en");
                    file_put_contents("../ehtml/product/" . $rowx["P_id"] . ".html", e(d(CreateProductInfo(c(b(a("productinfo", $rowx["P_id"])) , "productinfo") , $rowx["P_id"]))));
                }
            }
        }
        setlang($C_delang);
    ...
    if (check_auth2("x1")) {
        ...
        if (mysqli_num_rows($resultx) > 0) {
            while ($rowx = mysqli_fetch_assoc($resultx)) {
                ...
                if (strpos($T_lang, "0") !== false) {
                    setlang("cn");
                    file_put_contents("../html/product/list-" . $rowx["S_id"] . ".html", e(d(CreateProductList(c(b(a("product", $rowx["S_id"])) , "product") , $rowx["S_id"], 1))));
                    for ($q = 1; $q < $page_num + 1; $q++) {
                        file_put_contents("../html/product/list-" . $rowx["S_id"] . "-" . $q . ".html", e(d(CreateProductList(c(b(a("product", $rowx["S_id"])) , "product") , $rowx["S_id"], $q))));
                    }
                }
                if (strpos($T_lang, "2") !== false) {
                    setlang("cht");
                    file_put_contents("../fhtml/product/list-" . $rowx["S_id"] . ".html", cnfont(e(d(CreateProductList(c(b(a("product", $rowx["S_id"])) , "product") , $rowx["S_id"], 1))) , "f"));
                    for ($q = 1; $q < $page_num + 1; $q++) {
                        file_put_contents("../fhtml/product/list-" . $rowx["S_id"] . "-" . $q . ".html", cnfont(e(d(CreateProductList(c(b(a("product", $rowx["S_id"])) , "product") , $rowx["S_id"], $q))) , "f"));
                    }
                }
                if (strpos($T_lang, "1") !== false) {
                    setlang("en");
                    file_put_contents("../ehtml/product/list-" . $rowx["S_id"] . ".html", e(d(CreateProductList(c(b(a("product", $rowx["S_id"])) , "product") , $rowx["S_id"], 1))));
                    for ($q = 1; $q < $page_num + 1; $q++) {
                        file_put_contents("../ehtml/product/list-" . $rowx["S_id"] . "-" . $q . ".html", e(d(CreateProductList(c(b(a("product", $rowx["S_id"])) , "product") , $rowx["S_id"], $q))));
                    }
                }
            }
        }
        ...
        if (strpos($T_lang, "0") !== false) {
            setlang("cn");
            file_put_contents("../html/product/list-0.html", e(d(CreateProductList(c(b(a("product", 0)) , "product") , "0", 1))));
            for ($q = 1; $q < $page_num + 1; $q++) {
                file_put_contents("../html/product/list-0-" . $q . ".html", e(d(CreateProductList(c(b(a("product", 0)) , "product") , "0", $q))));
            }
        }
        if (strpos($T_lang, "2") !== false) {
            setlang("cht");
            file_put_contents("../fhtml/product/list-0.html", cnfont(e(d(CreateProductList(c(b(a("product", 0)) , "product") , "0", 1))) , "f"));
            for ($q = 1; $q < $page_num + 1; $q++) {
                file_put_contents("../fhtml/product/list-0-" . $q . ".html", cnfont(e(d(CreateProductList(c(b(a("product", 0)) , "product") , "0", $q))) , "f"));
            }
        }
        if (strpos($T_lang, "1") !== false) {
            setlang("en");
            file_put_contents("../ehtml/product/list-0.html", e(d(CreateProductList(c(b(a("product", 0)) , "product") , "0", 1))));
            for ($q = 1; $q < $page_num + 1; $q++) {
                file_put_contents("../ehtml/product/list-0-" . $q . ".html", e(d(CreateProductList(c(b(a("product", 0)) , "product") , "0", $q))));
            }
        }
        setlang($C_delang);
    }
    ...
    if (check_auth2("x1")) {
        ...
        if (mysqli_num_rows($resultx) > 0) {
            while ($rowx = mysqli_fetch_assoc($resultx)) {
                if (strpos($T_lang, "0") !== false) {
                    setlang("cn");
                    file_put_contents("../html/form/" . $rowx["F_id"] . ".html", e(d(CreateForm(c(b(a("form", $rowx["F_id"])) , "form") , $rowx["F_id"]))));
                }
                if (strpos($T_lang, "2") !== false) {
                    setlang("cht");
                    file_put_contents("../fhtml/form/" . $rowx["F_id"] . ".html", cnfont(e(d(CreateForm(c(b(a("form", $rowx["F_id"])) , "form") , $rowx["F_id"]))) , "f"));
                }
                if (strpos($T_lang, "1") !== false) {
                    setlang("en");
                    file_put_contents("../ehtml/form/" . $rowx["F_id"] . ".html", e(d(CreateForm(c(b(a("form", $rowx["F_id"])) , "form") , $rowx["F_id"]))));
                }
            }
        }
        setlang($C_delang);
...
function creat_guestbook($T_lang) {
    ...
    if (check_auth2("x1")) {
        if (strpos($T_lang, "0") !== false) {
            setlang("cn");
            file_put_contents("../html/guestbook/index.html", e(d(CreateGuestbook(c(b(a("guestbook", 1)) , "guestbook")))));
        }
        if (strpos($T_lang, "2") !== false) {
            setlang("cht");
            file_put_contents("../fhtml/guestbook/index.html", cnfont(e(d(CreateGuestbook(c(b(a("guestbook", 1)) , "guestbook")))) , "f"));
        }
        if (strpos($T_lang, "1") !== false) {
            setlang("en");
            file_put_contents("../ehtml/guestbook/index.html", e(d(CreateGuestbook(c(b(a("guestbook", 1)) , "guestbook")))));
        }
        setlang($C_delang);
    }
}
function creat_contact($T_lang) {
    ...
    if (check_auth2("x1")) {
        if (strpos($T_lang, "0") !== false) {
            setlang("cn");
            file_put_contents("../html/contact/index.html", e(d(CreateContact(c(b(a("contact", 1)) , "contact")))));
        }
        if (strpos($T_lang, "2") !== false) {
            setlang("cht");
            file_put_contents("../fhtml/contact/index.html", cnfont(e(d(CreateContact(c(b(a("contact", 1)) , "contact")))) , "f"));
        }
        if (strpos($T_lang, "1") !== false) {
            setlang("en");
            file_put_contents("../ehtml/contact/index.html", e(d(CreateContact(c(b(a("contact", 1)) , "contact")))));
        }
        setlang($C_delang);
    }
}
